...
Adapted from:
    RelGT project
    GitHub: https://github.com/snap-stanford/relgt
    Commit: 19e423ca3e7cac761130aba790857f2dc3a46ef7
    File: relgt/codebook.py
    Original authors: Stanford SNAP Lab
    MIT License

Note: VectorQuantizerEMA was itself adapted within the RelGT project from
    the GOAT repository (https://github.com/devnkong/GOAT).
