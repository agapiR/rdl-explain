...
class HeteroConv(torch.nn.Module):
    ...
    def forward_to_explain(
        self,
        mask: Dict[EdgeType, Tensor],
        elimination_strategy: str,
        *args_dict,
        **kwargs_dict,
    ) -> Dict[NodeType, Tensor]:
        r"""Runs the forward pass of the module with masking."""
        out_dict: Dict[str, List[Tensor]] = {}
        ...
        for edge_type, conv in self.convs.items():
            ...
            # Pass mask value to convolution, out = conv(*args, **kwargs)
            out = conv.forward_to_explain(mask[edge_type], elimination_strategy, *args, **kwargs)
